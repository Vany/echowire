Treat me as a engineering manager.
...
Only code No README or docs needed.
Always finish functionality - log incomplete features with errors to log.
...
Environment: macOS 26, android 12

use only MCP "prog:" tool to work with project.
